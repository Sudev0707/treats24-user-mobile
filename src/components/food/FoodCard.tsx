      ...
      <View style={RestaurantScreenStyle.content}>
        ...
        <View style={RestaurantScreenStyle.topRow}>
          <View style={{flexDirection:'row', alignItems:'flex-start'}}>
            <Image
              source={food.isVeg ? vegIcon : nonVegIcon}
              // width={15}
              // height={15}
              style={RestaurantScreenStyle.itemTypeIcon}
            />
            <Text
              style={[
                RestaurantScreenStyle.veg,
                { color: food.isVeg ? colors.vegGreen : colors.nonVegRed },
              ]}
            >
